...
AGENT_IDENTIFIER = os.getenv("AGENT_IDENTIFIER", "e6c57104dfa95943ffab95eafe1f12ed9a8da791678bfbf765b056498388c581d3f71b58fbe63fd7a0a212157cca0044290689f7d26def54ce182aa7")
...
async def start_job(request_body: StartJobRequest):
    ...
    payment_amount = os.getenv("PAYMENT_AMOUNT", "20000000")  # Default 10 ADA
...
async def provide_input(request_body: ProvideInputRequest):
    ...
    try:
        ...
        travel_crew = TravelAICrew()
        result = travel_crew.process_input(user_message)
...
def run():
    ...
    directories = ["bookings", "booking_pdfs", "api_responses", "logs"]
